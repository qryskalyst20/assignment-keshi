    ...
    <main className='w-full flex flex-row bg-neutral min-h-screen bg-neutral-50'>
      <div className='flex-[2] flex flex-col items-center justify-center'>
        ...
        <form className='flex flex-col items-center justify-center'>
          ...
          <button type="submit" className='w-80 h-12 rounded-3xl border-2 border-zinc-900 outline-none px-4 py-2 mt-4 bg-zinc-900 text-neutral-50 font-bold'>Login</button>
        </form>
